...
def preprocess_data(image_path, bbox, class_id):
    ...
    image = tf.io.decode_png(image_bytes, channels=3, dtype=tf.uint8)
...
def build_head(output_filters, bias_init):
    ...
    """
    head = keras.Sequential([keras.layers.InputLayer(input_shape=(None, None, 256))])
...
train_dataset = tf.data.Dataset.from_tensor_slices((file_paths, bboxes, class_ids))
